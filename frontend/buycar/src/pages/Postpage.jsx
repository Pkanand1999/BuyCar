...
function postComment(event){
    ...
    let detail={name:data.name,userid:data.id,postid:id,image:data.image,comment:content}
            ...
            <div className='w-[80%]  text-center mt-8 mb-10 flex flex-col'>
                ...
                <div className='bg-white rounded-md flex flex-col '>
                    ...
                    <div className='mb-6 mt-2 text-left mr-12 ml-12'>
                        <div className='flex'>
                        <div className='w-[40%]'><img className='w-full' src={post.image} alt="" /></div>
                        <div>
                        ...
                        <p className='mt-4'><span className='font-bold'>Discription : </span>{post.discription}</p>
                    </div>
                    {/* post div end  */}
                                ...
                                data.comments.map((cmt,i)=>{
                                    return <div className='flex flex-col p-2' key={i}>
                                        <div className='flex items-center'>
                                            <img className='w-[3%] rounded-full' src={cmt.image} alt="avatar" />
                                            <h1 className='ml-2 text-sm'>{cmt.name}</h1>
                                        </div>
                                        <div>
                                            <p className='text-sm font-sm ml-8'>{cmt.comment}</p>
                                        </div>
                                    </div>
                                })
                            }
