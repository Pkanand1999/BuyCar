...
const navigate=useNavigate();
  ...
  return (
    ...
    <div className="bg-[#95ffff] flex-column justify-center items-center text-sm rounded-xl w-full">
    <form className="p-5 flex-column font-medium w-full ">
      ...
      <button className="bg-[#022249] text-white p-1.5 w-full rounded-xl font-bold mt-4 cursor-pointer" onClick={loginUser}>Sign In</button>
    </form>
    </div>
